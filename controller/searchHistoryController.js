...
async function create(req, res) {
  ...
  const params = [
    ...
    { key: 'by', value: by || '' },
    { key: 'sort', value: sort || '' },
    { key: 'modelYearId', value: modelYearId || '' },
    { key: 'condition', value: condition || '' },
    { key: 'brandId', value: brandId || '' },
    { key: 'groupModelId', value: groupModelId || '' },
    ...
    { key: 'radius[0]', value: radius && Array.isArray(radius) && radius[0] ? radius[0] : '' },
    { key: 'radius[1]', value: radius && Array.isArray(radius) && radius[1] ? radius[1] : '' },
    { key: 'latitude', value: latitude || '' },
    { key: 'longitude', value: longitude || '' },
    { key: 'minKm', value: minKm || '' },
    { key: 'maxKm', value: maxKm || '' },
    { key: 'subdistrictId', value: subdistrictId || '' },
    { key: 'cityId', value: cityId || '' },
    { key: 'typeId', value: typeId || '' },
    { key: 'id', value: id || '' },
    { key: 'exteriorColorId', value: exteriorColorId || '' },
    { key: 'interiorColorId', value: interiorColorId || '' }
  ];
  ...
  await models.SearchHistoryParam.bulkCreate(params, { transaction: trans }).catch(err => {
    trans.rollback();
    res.status(422).json({
      success: false,
      errors: err.message
