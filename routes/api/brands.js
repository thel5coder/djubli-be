    ...
    attributes: Object.keys(models.Brand.attributes).concat([
      [
        models.sequelize.literal(
          '(SELECT MAX("Cars"."price") FROM "Cars" WHERE "Cars"."brandId" = "Brand"."id" AND "Cars"."deletedAt" IS NULL)'
        ),
        'maxPrice'
      ],
      [
        models.sequelize.literal(
          '(SELECT MIN("Cars"."price") FROM "Cars" WHERE "Cars"."brandId" = "Brand"."id" AND "Cars"."deletedAt" IS NULL)'
        ),
        'minPrice'
      ],
      [
        models.sequelize.literal(
          '(SELECT COUNT("Cars"."id") FROM "Cars" WHERE "Cars"."brandId" = "Brand"."id" AND "Cars"."deletedAt" IS NULL)'
        ),
        'numberOfCar'
      ]
    ]),
